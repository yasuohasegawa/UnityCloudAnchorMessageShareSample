...
// Update > touchScreen > _HostLastPlacedAnchor call >
...
namespace GoogleARCore.Examples.CloudAnchor
{
    ...
    public class CloudAnchorController : MonoBehaviour
    {
        ...
        public RoomSharingClient roomSharingClient;
        public RoomData data;
        
        public Camera arkitCam;

        public Camera arcoreCam;

        static private CloudAnchorController instance = null;
        static public CloudAnchorController GetInstance()
        {
            return instance;
        }
        ...
        public void OnResolveRoomClick()
        {
            ...
            roomSharingClient = new RoomSharingClient();
            ...
            roomSharingClient.OnTextRecieve = (string msg) =>
            {
                UIController.ShowMsgText(msg);
            };

            roomSharingClient.OnTouchRecieve = (int val) =>
            {
                data.touch = val;
            };
        }

        public void OnClientMsgSent() {
            if(roomSharingClient != null){
                roomSharingClient.SendMsgToHost();
            }
        }

        public void OnHostMsgSent()
        {
            RoomSharingServer.SentMsgToClient();
        }
        ...
        private void _HostLastPlacedAnchor()
        {
            ...
            XPSession.CreateCloudAnchor(anchor).ThenAction(result =>
            {
                ...
                RoomSharingServer.OnTextRecieve = (string msg) => {
                    UIController.ShowMsgText(msg);
                };

                RoomSharingServer.OnTouchRecieve = (int val) =>
                {
                    data.touch = val;
                };
